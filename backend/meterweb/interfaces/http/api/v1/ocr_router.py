...
def run_ocr(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_422_UNPROCESSABLE_ENTITY, detail="Bilddatei nicht gefunden.") from exc
    except RuntimeError as exc:
        raise HTTPException(
            status_code=status.HTTP_422_UNPROCESSABLE_ENTITY,
            detail="OCR-Verarbeitung derzeit nicht verfügbar.",
        ) from exc
